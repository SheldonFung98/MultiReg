...
from multireg.utils.torch_utils import get_activation, get_dropout
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, input_q, input_k, input_v, key_masks=None, attention_factors=None):
        ...
        """ print("1")
        print(input_q[input_q.isnan()])
        print(input_k[input_k.isnan()])
        print(attention_scores[attention_scores.isnan()]) """
