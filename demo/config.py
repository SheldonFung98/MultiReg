...
from multireg.utils.python_utils import ensure_dir
...
# data
config.voxel_size =0.0015
config.matching_radius = config.voxel_size * 2
#eval
config.re_thre = 15
config.te_thre = config.voxel_size * 4#0.01
# train config
...
# model - Global
config.instance_mask_thre=0.5

config.geodesic_radis=0.012
config.cluster_thre=0.3
...
config.max_neighboor=32
config.finematch_max_point = 256
